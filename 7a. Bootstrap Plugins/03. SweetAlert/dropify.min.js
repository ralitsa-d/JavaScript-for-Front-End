...
<html lang="en">
  ...
  <title>dropify/dropify.min.js at master · JeremyFagis/dropify · GitHub</title>
  ...
  <meta name="request-id" content="0A8F:2424:8CBE0BC:FCD9CEE:5B5F5F8B" data-pjax-transient>
...
<meta name="octolytics-host" content="collector.githubapp.com" /><meta name="octolytics-app-id" content="github" /><meta name="octolytics-event-url" content="https://collector.githubapp.com/github-external/browser_event" /><meta name="octolytics-dimension-request_id" content="0A8F:2424:8CBE0BC:FCD9CEE:5B5F5F8B" /><meta name="octolytics-dimension-region_edge" content="iad" /><meta name="octolytics-dimension-region_render" content="iad" />
...
<meta class="js-ga-set" name="dimension1" content="Logged Out">
    ...
    <meta name="js-proxy-site-detection-payload" content="">
  ...
  <meta name="html-safe-nonce" content="3b48b2515c7d811cc5fec21f5100e28f7c9978a3">
  ...
  <meta name="octolytics-dimension-user_id" content="4066313" /><meta name="octolytics-dimension-user_login" content="JeremyFagis" /><meta name="octolytics-dimension-repository_id" content="31362891" /><meta name="octolytics-dimension-repository_nwo" content="JeremyFagis/dropify" /><meta name="octolytics-dimension-repository_public" content="true" /><meta name="octolytics-dimension-repository_is_fork" content="false" /><meta name="octolytics-dimension-repository_network_root_id" content="31362891" /><meta name="octolytics-dimension-repository_network_root_nwo" content="JeremyFagis/dropify" /><meta name="octolytics-dimension-repository_explore_github_marketplace_ci_cta_shown" content="false" />
    ...
    <link rel="canonical" href="https://github.com/JeremyFagis/dropify/blob/master/dist/js/dropify.min.js" data-pjax-transient>
...
>
    ...
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="js-site-search-form" data-scope-type="Repository" data-scope-id="31362891" data-scoped-search-url="/JeremyFagis/dropify/search" data-unscoped-search-url="/search" action="/JeremyFagis/dropify/search" accept-charset="UTF-8" method="get"><input name="utf8" type="hidden" value="&#x2713;" />
      <label class="form-control header-search-wrapper header-search-wrapper-jump-to position-relative d-flex flex-justify-between flex-items-center js-chromeless-input-container">
        <input type="text"
          ...
          data-jump-to-suggestions-path="/_graphql/GetSuggestedNavigationDestinations#csrf-token=c6RFllC4XB5KJ7OsqaGNaiJ9weqKJqd7szp0+p8Xl2eDmRFo8c+wmjKL74VDGQUDXN5NpRWpt7FPK4vDPh45sg=="
          spellcheck="false"
          autocomplete="off"
          >
          ...
          <span class="d-inline-block">
              <div class="HeaderNavlink px-0 py-2 m-0">
                <a class="text-bold text-white no-underline" href="/login?return_to=%2FJeremyFagis%2Fdropify%2Fblob%2Fmaster%2Fdist%2Fjs%2Fdropify.min.js" data-ga-click="(Logged out) Header, clicked Sign in, text:sign-in; experiment:site_header_dropdowns; group:control">Sign in</a>
  ...
  <li>
    ...
    <a href="/JeremyFagis/dropify/network/members" class="social-count"
...
<div class="container new-discussion-timeline experiment-repo-nav  ">
  ...
  <a class="d-none js-permalink-shortcut" data-hotkey="y" href="/JeremyFagis/dropify/blob/27feaf9bbab4dda682ec5b79166aa6dd19f66164/dist/js/dropify.min.js">Permalink</a>

  <!-- blob contrib key: blob_contributors:v21:533f4ce04dec55fa52f966aa169bcbff -->

      <div class="signup-prompt-bg rounded-1">
      <div class="signup-prompt p-4 text-center mb-4 rounded-1">
        <div class="position-relative">
          <!-- '"` --><!-- </textarea></xmp> --></option></form><form action="/site/dismiss_signup_prompt" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="3KFLkSny7bUG53Sy4tZQiTG5HnQ8kvQHcIpvtwAR+aWFu5CFeNMoYyFKKBEQIlLOIK01I2SDLWgLvGeDWlQYpQ==" />
...
<div class="select-menu branch-select-menu js-menu-container js-select-menu float-left">
  ...
  <div class="select-menu-modal-holder js-menu-content js-navigation-container" data-pjax>
    ...
    <div class="select-menu-modal">
      ...
      <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket" data-tab-filter="branches" role="menu">
        ...
        <div data-filterable-for="context-commitish-filter-field" data-filterable-type="substring">
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
               href="/JeremyFagis/dropify/blob/gh-pages/dist/js/dropify.min.js"
               data-name="gh-pages"
               data-skip-pjax="true"
               rel="nofollow">
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open selected"
               href="/JeremyFagis/dropify/blob/master/dist/js/dropify.min.js"
               data-name="master"
               data-skip-pjax="true"
               rel="nofollow">
              <svg class="octicon octicon-check select-menu-item-icon" viewBox="0 0 12 16" version="1.1" width="12" height="16" aria-hidden="true"><path fill-rule="evenodd" d="M12 5l-8 8-4-4 1.5-1.5L4 10l6.5-6.5L12 5z"/></svg>
      ...
      <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket" data-tab-filter="tags">
        <div data-filterable-for="context-commitish-filter-field" data-filterable-type="substring">
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
              href="/JeremyFagis/dropify/tree/0.2.2/dist/js/dropify.min.js"
              data-name="0.2.2"
              data-skip-pjax="true"
              rel="nofollow">
              <svg class="octicon octicon-check select-menu-item-icon" viewBox="0 0 12 16" version="1.1" width="12" height="16" aria-hidden="true"><path fill-rule="evenodd" d="M12 5l-8 8-4-4 1.5-1.5L4 10l6.5-6.5L12 5z"/></svg>
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
              href="/JeremyFagis/dropify/tree/0.2.1/dist/js/dropify.min.js"
              data-name="0.2.1"
              data-skip-pjax="true"
              rel="nofollow">
              <svg class="octicon octicon-check select-menu-item-icon" viewBox="0 0 12 16" version="1.1" width="12" height="16" aria-hidden="true"><path fill-rule="evenodd" d="M12 5l-8 8-4-4 1.5-1.5L4 10l6.5-6.5L12 5z"/></svg>
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
              href="/JeremyFagis/dropify/tree/0.2.0/dist/js/dropify.min.js"
              data-name="0.2.0"
              data-skip-pjax="true"
              rel="nofollow">
              <svg class="octicon octicon-check select-menu-item-icon" viewBox="0 0 12 16" version="1.1" width="12" height="16" aria-hidden="true"><path fill-rule="evenodd" d="M12 5l-8 8-4-4 1.5-1.5L4 10l6.5-6.5L12 5z"/></svg>
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
              href="/JeremyFagis/dropify/tree/0.1.3/dist/js/dropify.min.js"
              data-name="0.1.3"
              data-skip-pjax="true"
              rel="nofollow">
              <svg class="octicon octicon-check select-menu-item-icon" viewBox="0 0 12 16" version="1.1" width="12" height="16" aria-hidden="true"><path fill-rule="evenodd" d="M12 5l-8 8-4-4 1.5-1.5L4 10l6.5-6.5L12 5z"/></svg>
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
              href="/JeremyFagis/dropify/tree/0.1.2/dist/js/dropify.min.js"
              data-name="0.1.2"
              data-skip-pjax="true"
              rel="nofollow">
              <svg class="octicon octicon-check select-menu-item-icon" viewBox="0 0 12 16" version="1.1" width="12" height="16" aria-hidden="true"><path fill-rule="evenodd" d="M12 5l-8 8-4-4 1.5-1.5L4 10l6.5-6.5L12 5z"/></svg>
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
              href="/JeremyFagis/dropify/tree/0.1.1/dist/js/dropify.min.js"
              data-name="0.1.1"
              data-skip-pjax="true"
              rel="nofollow">
              <svg class="octicon octicon-check select-menu-item-icon" viewBox="0 0 12 16" version="1.1" width="12" height="16" aria-hidden="true"><path fill-rule="evenodd" d="M12 5l-8 8-4-4 1.5-1.5L4 10l6.5-6.5L12 5z"/></svg>
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
              href="/JeremyFagis/dropify/tree/0.1.0/dist/js/dropify.min.js"
              data-name="0.1.0"
              data-skip-pjax="true"
              rel="nofollow">
              <svg class="octicon octicon-check select-menu-item-icon" viewBox="0 0 12 16" version="1.1" width="12" height="16" aria-hidden="true"><path fill-rule="evenodd" d="M12 5l-8 8-4-4 1.5-1.5L4 10l6.5-6.5L12 5z"/></svg>
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
              href="/JeremyFagis/dropify/tree/0.0.6/dist/js/dropify.min.js"
              data-name="0.0.6"
              data-skip-pjax="true"
              rel="nofollow">
              <svg class="octicon octicon-check select-menu-item-icon" viewBox="0 0 12 16" version="1.1" width="12" height="16" aria-hidden="true"><path fill-rule="evenodd" d="M12 5l-8 8-4-4 1.5-1.5L4 10l6.5-6.5L12 5z"/></svg>
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
              href="/JeremyFagis/dropify/tree/0.0.5/dist/js/dropify.min.js"
              data-name="0.0.5"
              data-skip-pjax="true"
              rel="nofollow">
              <svg class="octicon octicon-check select-menu-item-icon" viewBox="0 0 12 16" version="1.1" width="12" height="16" aria-hidden="true"><path fill-rule="evenodd" d="M12 5l-8 8-4-4 1.5-1.5L4 10l6.5-6.5L12 5z"/></svg>
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
              href="/JeremyFagis/dropify/tree/0.0.4/dist/js/dropify.min.js"
              data-name="0.0.4"
              data-skip-pjax="true"
              rel="nofollow">
              <svg class="octicon octicon-check select-menu-item-icon" viewBox="0 0 12 16" version="1.1" width="12" height="16" aria-hidden="true"><path fill-rule="evenodd" d="M12 5l-8 8-4-4 1.5-1.5L4 10l6.5-6.5L12 5z"/></svg>
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
              href="/JeremyFagis/dropify/tree/0.0.3/dist/js/dropify.min.js"
              data-name="0.0.3"
              data-skip-pjax="true"
              rel="nofollow">
              <svg class="octicon octicon-check select-menu-item-icon" viewBox="0 0 12 16" version="1.1" width="12" height="16" aria-hidden="true"><path fill-rule="evenodd" d="M12 5l-8 8-4-4 1.5-1.5L4 10l6.5-6.5L12 5z"/></svg>
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
              href="/JeremyFagis/dropify/tree/0.0.2/dist/js/dropify.min.js"
              data-name="0.0.2"
              data-skip-pjax="true"
              rel="nofollow">
              <svg class="octicon octicon-check select-menu-item-icon" viewBox="0 0 12 16" version="1.1" width="12" height="16" aria-hidden="true"><path fill-rule="evenodd" d="M12 5l-8 8-4-4 1.5-1.5L4 10l6.5-6.5L12 5z"/></svg>
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
              href="/JeremyFagis/dropify/tree/0.0.1/dist/js/dropify.min.js"
              data-name="0.0.1"
              data-skip-pjax="true"
              rel="nofollow">
              <svg class="octicon octicon-check select-menu-item-icon" viewBox="0 0 12 16" version="1.1" width="12" height="16" aria-hidden="true"><path fill-rule="evenodd" d="M12 5l-8 8-4-4 1.5-1.5L4 10l6.5-6.5L12 5z"/></svg>
    ...
    <div id="blob-path" class="breadcrumb">
      <span class="repo-root js-repo-root"><span class="js-path-segment"><a data-pjax="true" href="/JeremyFagis/dropify"><span>dropify</span></a></span></span><span class="separator">/</span><span class="js-path-segment"><a data-pjax="true" href="/JeremyFagis/dropify/tree/master/dist"><span>dist</span></a></span><span class="separator">/</span><span class="js-path-segment"><a data-pjax="true" href="/JeremyFagis/dropify/tree/master/dist/js"><span>js</span></a></span><span class="separator">/</span><strong class="final-path">dropify.min.js</strong>
    </div>
  </div>


  <include-fragment src="/JeremyFagis/dropify/contributors/master/dist/js/dropify.min.js" class="commit-tease commit-loader">
    <div>
  ...
  <div class="file-actions">
    ...
    <div class="BtnGroup">
      <a id="raw-url" class="btn btn-sm BtnGroup-item" href="/JeremyFagis/dropify/raw/master/dist/js/dropify.min.js">Raw</a>
        <a class="btn btn-sm js-update-url-with-hash BtnGroup-item" data-hotkey="b" href="/JeremyFagis/dropify/blame/master/dist/js/dropify.min.js">Blame</a>
      <a rel="nofollow" class="btn btn-sm BtnGroup-item" href="/JeremyFagis/dropify/commits/master/dist/js/dropify.min.js">History</a>
    </div>
  ...
  <div itemprop="text" class="blob-wrapper data type-javascript">
      ...
      <tr>
        ...
        <td id="LC3" class="blob-code blob-code-inner js-file-line"><span class="pl-c"> * dropify v0.2.1 - Override your input files with style.</span></td>
      </tr>
      <tr>
        <td id="L4" class="blob-num js-line-number" data-line-number="4"></td>
        <td id="LC4" class="blob-code blob-code-inner js-file-line"><span class="pl-c"> * https://github.com/JeremyFagis/dropify</span></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC6" class="blob-code blob-code-inner js-file-line"><span class="pl-c"> * (c) 2016 - Jeremy FAGIS &lt;jeremy@fagis.fr&gt; (http://fagis.fr)</span></td>
      </tr>
      <tr>
  ...
  <details class="details-reset details-overlay BlobToolbar position-absolute js-file-line-actions dropdown d-none" aria-hidden="true">
    ...
    <details-menu>
      <ul class="BlobToolbar-dropdown dropdown-menu dropdown-menu-se mt-2">
        ...
        <li><a class="dropdown-item js-update-url-with-hash" id="js-view-git-blame" role="menuitem" href="/JeremyFagis/dropify/blame/27feaf9bbab4dda682ec5b79166aa6dd19f66164/dist/js/dropify.min.js">View git blame</a></li>
          <li><a class="dropdown-item" id="js-new-issue" role="menuitem" href="/JeremyFagis/dropify/issues/new">Open new issue</a></li>
      </ul>
    </details-menu>
  </details>
...
<div class="footer container-lg px-3" role="contentinfo">
  <div class="position-relative d-flex flex-justify-between pt-6 pb-2 mt-6 f6 text-gray border-top border-gray-light ">
    <ul class="list-style-none d-flex flex-wrap ">
      <li class="mr-3">&copy; 2018 <span title="0.14562s from unicorn-5568474c9-tkcqv">GitHub</span>, Inc.</li>
